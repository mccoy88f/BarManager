...
- **Non implementato** (fuori scope di questa v1, vedi §10): l'invio vero e proprio di campagne pubblicitarie via email/SMS/WhatsApp — `marketingConsent` identifica chi può essere contattato, ma il canale di invio stesso (provider email/SMS/WhatsApp, template, pianificazione) resta da costruire.
